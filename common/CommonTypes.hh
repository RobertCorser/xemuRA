...
// Had to rename this from Clock to CommonClock. This was clashing with another Clock struct. 
// There's probably a way to isolate the two that results in this not being renamed but if there is I don't know how to do that.
using CommonClock = std::chrono::steady_clock;
using TimePoint = CommonClock::time_point;
using DT = CommonClock::duration;
